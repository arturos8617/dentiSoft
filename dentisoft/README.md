...
Sistema web de gestion para clinicas dentales
...
un *worker* de Celery, ya que la tarea de envío se ejecuta de forma
asíncrona. En el entorno local los mensajes no se mandan a la dirección
real; se capturan en el servidor Mailpit disponible en
`http://127.0.0.1:8025`.